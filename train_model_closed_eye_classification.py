...
opt = optimizers.Adam(learning_rate=0.0003, epsilon=1e-8)
...
model.save('ProjectCode\models\closedEyeClassifier.h5', overwrite=True)
...
try:
    utils.plot_model(model, to_file='ProjectCode\models\closedEyeClassifier_model_arch.png', show_shapes=True, show_layer_names=True)
except:
    pass
